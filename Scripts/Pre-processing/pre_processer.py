...
def preprocess_data(input_file, output_file, save_dir='preprocessed_chunks_1Mill', chunksize=50000):
    """
...
if __name__ == "__main__":
    ...
    input_file  = '1MilltestBernstein_p1_data.txt'
    output_file = '1MilltestBernstein_p1_output.txt'
