...
model_dir = "/work/home/ng66sume/MasterThesis/Models/FNN_model_v5.3/"
results_dir = "/work/home/ng66sume/MasterThesis/Test_Results/Test_FNN_v5.3/"
os.makedirs(results_dir, exist_ok=True)

# Load the model from the specified directory and set it to evaluation mode.
model_path = os.path.join(model_dir, 'fnn_model_weights_v4.2.pth')
