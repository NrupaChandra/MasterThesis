...
model_dir = "/work/home/ng66sume/MasterThesis/Models/FNN_high_order/High_order_V1/"
results_dir = "/work/home/ng66sume/MasterThesis/Test_Results/FNN_high_order/High_order_V1/"
os.makedirs(results_dir, exist_ok=True)

# Load the model from the specified directory and set it to evaluation mode.
model_path = os.path.join(model_dir, 'fnn_model_weights_v1.pth')
