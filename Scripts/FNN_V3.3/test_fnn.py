...
model_dir = "/work/home/ng66sume/MasterThesis/Models/FNN_model_v3.3/"
results_dir = "/work/home/ng66sume/MasterThesis/Test_Results/Test_FNN_v3.3/"
os.makedirs(results_dir, exist_ok=True)

# Load the model from the specified directory and set it to evaluation mode.
model_path = os.path.join(model_dir, 'fnn_model_weights_v3.3.pth')
...
# Visualization: Plot histogram of relative errors (in percentage)
plt.figure(figsize=(10, 6))
plt.hist([x * 100 for x in relative_errors], bins=20, edgecolor='black')
