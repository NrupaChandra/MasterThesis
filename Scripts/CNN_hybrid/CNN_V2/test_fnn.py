...
model_dir = "/work/scratch/ng66sume/Models/CNN_hybrid/CNN_v2/"
results_dir = "/work/scratch/ng66sume/Test_Results/CNN_hybrid/Test_CNN_hybrid_v2/"
os.makedirs(results_dir, exist_ok=True)

# Load the model from the specified directory and set it to evaluation mode.
model_path = os.path.join(model_dir, 'fnn_model_weights_v2.pth')
