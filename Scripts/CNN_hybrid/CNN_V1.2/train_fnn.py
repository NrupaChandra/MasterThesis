...
model_dir = "/work/home/ng66sume/MasterThesis/Models/CNN_hybrid/CNN_v1.2/"
...
if __name__ == "__main__":
    ...
    # Instantiate the CNN_FNN model using load_shallow_cnn_model.
    model = load_shallow_cnn_model(hidden_dim=256, output_dim=256, max_output_len=16,
                                   num_nodes=1225, domain=(-1,1), dropout_rate=0.0)
    model.to(device)
