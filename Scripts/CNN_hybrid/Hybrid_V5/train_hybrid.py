...
from model_hybrid import load_shallow_cnn_model, save_checkpoint, load_checkpoint
import os
import numpy as np
...
def masked_and_integration_loss(exp_x, exp_y, coeff, pred_nodes_x, pred_nodes_y, pred_weights, 
    ...
    total_loss = integration_loss + 0.1881*penalty 
    return total_loss
...
def train_fnn(model, train_dataloader, val_dataloader, optimizer, criterion, test_functions, 
    ...
    final_model_path = os.path.join(model_dir, 'fnn_model_weights_v4.pth')
