...
# ----------------------------
file_path = r"C:\Git\RESULTS\Hybrid\console_output.txt"

# ----------------------------
# 3. Parse the Console Output
# ----------------------------
# Updated regexes to match the actual console lines:
...
for i in range(len(lines)):
    ...
    if tm:
        ...
        # Next three lines correspond to Predicted, Absolute Diff, and Relative Error
...
if df.empty:
    raise RuntimeError("Parsed DataFrame is empty—no matching lines were found in console_output.txt.")
...
# ----------------------------
fig1, ax1 = plt.subplots(figsize=(6, 4))  # Match size with histogram
...
ax1.set_title('Predicted vs True Integrals - Hybrid', fontsize=12)
...
plt.tight_layout()
plt.savefig('scatter_pred_vs_true_improved_hybrid.png', dpi=300)
plt.close()
...
ax4.set_title('Histogram of Relative Errors - Hybrid', fontsize=12)
...
plt.tight_layout()
plt.savefig('hist_relative_error_log_bins_power10_blue_hybrid.png', dpi=300)
plt.close()
