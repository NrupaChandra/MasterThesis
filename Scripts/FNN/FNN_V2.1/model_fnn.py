...
class FeedForwardNN(nn.Module):
    def __init__(self, hidden_dim, output_dim, max_output_len, num_residual=1, dropout=0.1, num_nodes=25, domain=(-1,1)):
...
def load_ff_pipelines_model(weights_path=None, hidden_dim=1024, output_dim=1024, max_output_len=16,
                            num_residual=1, dropout=0.1, num_nodes=25, domain=(-1,1)):
