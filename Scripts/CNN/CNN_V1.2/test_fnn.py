...
model_dir = "/work/scratch/ng66sume/MasterThesis/Models/CNN/CNN_V1.2/"
results_dir = "/work/scratch/ng66sume/MasterThesis/Test_Results/CNN/CNN_V1.2/"
os.makedirs(results_dir, exist_ok=True)

# Load the model checkpoint and set to evaluation mode.
model_path = os.path.join(model_dir, 'cnn_model_weights_v1.2.pth')
