...
model_dir = "/work/home/ng66sume/MasterThesis/Models/CNN/CNN_V1.2/"
...
def custom_collate_fn(batch):
    ...
    #A tensor of shape (batch_size, max_len) where each entry is 1 if it corresponds to an original data point, or 0 if it's padding.
...
def train_cnn(model, train_dataloader, val_dataloader, optimizer, criterion, test_functions, 
              num_nodes, domain, epochs, checkpoint_path=None, save_every=5):
    ...
    final_model_path = os.path.join(model_dir, 'cnn_model_weights_v1.2.pth')
