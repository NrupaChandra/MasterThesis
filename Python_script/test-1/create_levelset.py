import torch
from dataloader_transformer_1 import PolynomialDataset  # Import the dataset class
import numpy as np
...
# Load the dataset
input_file = "ValidateBernstein_p1_data.txt"  
output_file = "ValidateBernstein_p1_output.txt"  
